...
public class VillagerNPC extends NPC {
	...
	public enum SkinType {
		...
		public static SkinType fromId(int id)
		{
			switch(id)
			{
			case 0: return SkinType.FARMER;
			case 1: return SkinType.LIBRARIAN;
			case 2: return SkinType.PRIEST;
			case 3: return SkinType.BLACKSMITH;
			case 4: return SkinType.BUTCHER;
			default: return SkinType.REGULAR;
			}
		}
	}
	...
	public SkinType getSkin()
	{
		try
		{
			Field field = EntityVillager.class.getDeclaredField("profession");
			field.setAccessible(true);
			return SkinType.fromId(field.getInt((EntityVillager)this.entity));
		} catch(Exception ex)
		{
			ex.printStackTrace();
		}
